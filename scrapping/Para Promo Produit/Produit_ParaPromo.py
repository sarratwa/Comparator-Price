...
for link in ProductLinks:
    ...
    # Prod_Det
    try:
        Prod_Det = soup2.find("div", {
            "class": "woocommerce-Tabs-panel woocommerce-Tabs-panel--description panel entry-content wc-tab"}).text
    except:
        Prod_Det = ("-")

    Para = {"Produit": Product_Name, "Prix": Price, "Remise": Discount, "Description": Prod_Det, "Lien": link}
