...
Cleopatre_Cadeaux_Product = []
c = 0
ProductLinks = []

for i in range(1,22):
    Site = requests.get('https://www.cleopatre.tn/36-cadeaux?page={}'.format(i)).text
...
#Prod_Det
    ...
    Cleopatre_Cadeaux_Product.append(Cleopatre)
    c += 1
    print("Completed",c)

CadeauxAllProduct = pd.DataFrame(Cleopatre_Cadeaux_Product)

#To Execl
CadeauxAllProduct.to_excel("Produit_CadeauxCleopatre.xlsx",index=False)