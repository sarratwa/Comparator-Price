...
Cleopatre_Aromatherapie_Product = []
c = 0
ProductLinks = []

for i in range(1,13):
    Site = requests.get('https://www.cleopatre.tn/39-aromatherapie?page={}'.format(i)).text
...
#Prod_Det
    ...
    Cleopatre_Aromatherapie_Product.append(Cleopatre)
    c += 1
    print("Completed",c)

AromatherapieAllProduct = pd.DataFrame(Cleopatre_Aromatherapie_Product)
print(AromatherapieAllProduct)
#To Execl
AromatherapieAllProduct.to_excel("Produit_AromatherapieCleopatre.xlsx",index=False)