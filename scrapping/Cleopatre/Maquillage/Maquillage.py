...
Cleopatre_Maquillage_Product = []
c = 0
ProductLinks = []

for i in range(1,31):
    Site = requests.get('https://www.cleopatre.tn/32-maquillage?page={}'.format(i)).text
...
#Prod_Det
    ...
    Cleopatre_Maquillage_Product.append(Cleopatre)
    c += 1
    print("Completed",c)

MaquillageAllProduct = pd.DataFrame(Cleopatre_Maquillage_Product)

#To Execl
MaquillageAllProduct.to_excel("Produit_MaquillageCleopatre.xlsx",index=False)