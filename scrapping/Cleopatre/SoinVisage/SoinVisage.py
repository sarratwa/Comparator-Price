...
for i in range(1,87):
    Site = requests.get('https://www.cleopatre.tn/12-soin-visage?page={}'.format(i)).text
...
VisageAllProduct = pd.DataFrame(Cleopatre_Visage_Product)

#To Execl
VisageAllProduct.to_excel("Produit_VisageCleopatre.xlsx",index=False)