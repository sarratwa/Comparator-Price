...
#Image
    ...
    Dentaire = {"title":Product_Name, "price":Price, "description":Prod_Det, "link":link, "Image":Image, "categorie":"Autre"}
...
#To Excel
AnaisAllProduct_Orthopedie.to_csv("Orthopedie_AnaisProduct.csv",index=False)
