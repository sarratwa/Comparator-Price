...
ProductLinks = []
for i in range(1,21):
    CorpsSite = requests.get("https://anais.tn/product-category/corps/page/{}/".format(i)).text
    soup = BeautifulSoup(CorpsSite,'html.parser')
...
#Prod_Det
    try:
        ...
        Prod_Det = ("-")
    Corps = {"Produit":Product_Name, "Prix initiale":New_Price, "Ancien prix":Old_Price, "Description":Prod_Det, "Lien":Links}    
