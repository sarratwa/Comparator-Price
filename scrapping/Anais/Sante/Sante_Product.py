...
#Image
    ...
    Sante = {"title":Product_Name, "price":Price, "description":Prod_Det, "link":link, "Image":Image, "categorie":"Complements"}
...
#To Excel
AnaisAllProduct_Sante.to_csv("Sante_AnaisProduct.csv",index=False)