...
#Image
    ...
    Minceur = {"title":Product_Name, "price":Price, "description":Prod_Det, "link":link, "Image":Image, "categorie":"Autre"}
...
#To Excel
AnaisAllProduct_Minceur.to_csv("Minceur_AnaisProduct.csv",index=False)
