...
#Image
    ...
    Cheveux = {"Produit":Product_Name, "Prix":Price, "Description":Prod_Det, "Lien":link, "Image":Image}
...
#To Excel
AnaisAllProduct_Cheveux.to_excel("Cheveux_AnaisProduct.xlsx",index=False)