...
for i in range(1,11):
    NatAromaSite = requests.get("https://anais.tn/product-category/naturel-aromatherapie/page/{}/".format(i)).text
    soup = BeautifulSoup(NatAromaSite,'html.parser')
...
#Prod_Det
    ...
    NatAroma = {"Produit":Product_Name, "Prix":Price, "Description":Prod_Det, "Lien":link}    
