...
#Image
    ...
    Solaire = {"title":Product_Name, "price":Price, "description":Prod_Det, "link":link, "Image":Image, "categorie":"Solaire"}
...
#To Excel
AnaisAllProduct_Solaire.to_csv("Solaire_AnaisProduct.csv",index=False)
