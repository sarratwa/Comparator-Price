...
PharmaShop_MatMedical_Product = []
c = 0
ProductLinks = []

for i in range(1,18):
    Site = requests.get("https://www.pharma-shop.tn/1030-materiel-medical#/page-{}".format(i)).text
...
#Image
    ...
    PharmaShop_MatMedical_Product.append(PharmaShop)
    c += 1
    print("Completed",c)
    
PharmaShopMatMedicalProd = pd.DataFrame(PharmaShop_MatMedical_Product)

#To Excel
PharmaShopMatMedicalProd.to_excel("PharmaShop_MatMedical.xlsx",index=False)