...
PharmaShopBebeMamanProd = pd.DataFrame(PharmaShop_BebeMaman_Product)

#To Excel
PharmaShopBebeMamanProd.to_excel("PharmaShop_Bebe&Maman.xlsx",index=False)