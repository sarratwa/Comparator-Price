...
PharmaShop_Solaires_Product = []
c = 0
ProductLinks = []

for i in range(1,57):
    Site = requests.get("https://www.pharma-shop.tn/1013-solaires#/page-{}".format(i)).text
...
#Prd_Det
    ...
    PharmaShop_Solaires_Product.append(PharmaShop)
    c += 1
    print("Completed",c)
    
PharmaShopSolairesProd = pd.DataFrame(PharmaShop_Solaires_Product)

#To Excel
PharmaShopSolairesProd.to_excel("PharmaShop_Solaires.xlsx",index=False)