...
PharmaShop_BioNaturel_Product = []
c = 0
ProductLinks = []

for i in range(1,20):
    Site = requests.get("https://www.pharma-shop.tn/1023-bio-naturel#/page-{}".format(i)).text
...
#Image
    ...
    PharmaShop_BioNaturel_Product.append(PharmaShop)
    c += 1
    print("Completed",c)
    
PharmaShopBioNaturelProd = pd.DataFrame(PharmaShop_BioNaturel_Product)

#To Excel
PharmaShopBioNaturelProd.to_excel("PharmaShop_BioNaturel.xlsx",index=False)