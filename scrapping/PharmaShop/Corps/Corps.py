...
PharmaShop_Corps_Product = []
c = 0
ProductLinks = []

for i in range(1,41):
    Site = requests.get("https://www.pharma-shop.tn/887-corps#/page-{}".format(i)).text
...
#Image
    ...
    PharmaShop_Corps_Product.append(PharmaShop)
    c += 1
    print("Completed",c)
    
PharmaShopCorpsProd = pd.DataFrame(PharmaShop_Corps_Product)

#To Excel
PharmaShopCorpsProd.to_excel("PharmaShop_Corps.xlsx",index=False)