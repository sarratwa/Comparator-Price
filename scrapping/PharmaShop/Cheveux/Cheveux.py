...
PharmaShop_Cheveux_Product = []
c = 0
ProductLinks = []

for i in range(1,58):
    Site = requests.get("https://www.pharma-shop.tn/906-cheveux#/page-{}".format(i)).text
...
#Image
    ...
    PharmaShop_Cheveux_Product.append(PharmaShop)
    c += 1
    print("Completed",c)
    
PharmaShopCheveuxProd = pd.DataFrame(PharmaShop_Cheveux_Product)

#To Excel
PharmaShopCheveuxProd.to_excel("PharmaShop_Cheveux.xlsx",index=False)