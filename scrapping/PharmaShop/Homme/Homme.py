...
PharmaShop_Homme_Product = []
c = 0
ProductLinks = []

for i in range(1,4):
    Site = requests.get("https://www.pharma-shop.tn/871-homme#/page-{}".format(i)).text
...
#Image
    ...
    PharmaShop_Homme_Product.append(PharmaShop)
    c += 1
    print("Completed",c)
    
PharmaShopHommeProd = pd.DataFrame(PharmaShop_Homme_Product)

#To Excel
PharmaShopHommeProd.to_excel("PharmaShop_Homme.xlsx",index=False)