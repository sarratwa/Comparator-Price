...
PharmaShop_Visage_Product = []
c = 0
ProductLinks = []

for i in range(1,118):
    Site = requests.get("https://www.pharma-shop.tn/839-visage#/page-{}".format(i)).text
...
PharmaShopVisageProd = pd.DataFrame(PharmaShop_Visage_Product)

#To Excel
PharmaShopVisageProd.to_excel("PharmaShop_Visage.xlsx",index=False)