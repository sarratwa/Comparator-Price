...
PharmaShop_CompAliment_Product = []
c = 0
ProductLinks = []

for i in range(1,40):
    Site = requests.get("https://www.pharma-shop.tn/957-complements-alimentaires#/page-{}".format(i)).text
...
#Prd_Det
    ...
    PharmaShop_CompAliment_Product.append(PharmaShop)
    c += 1
    print("Completed",c)
    
PharmaShopCompAlimentProd = pd.DataFrame(PharmaShop_CompAliment_Product)

#To Excel
PharmaShopCompAlimentProd.to_excel("PharmaShop_CompAliment.xlsx",index=False)